...
$settings = new Settings;
    ...
    foreach ($all_id_event_tboil as $key => $value) {
        ...
        $resourse = isset(json_decode($check_id_referer)->data->id) ? json_decode($check_id_referer)->data->id : 0;

        $response = $settings->add_update_new_event($id_event_on_referer,$type_event,$name,$description,$organizer,$status,$start_datetime_event,$end_datetime_event,$place,$interest,$resourse);
