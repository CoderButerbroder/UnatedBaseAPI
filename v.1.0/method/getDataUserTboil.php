...
if ($data_user_tboil) {
      ...
      echo json_encode(array('response' => false, 'description' => 'Не все обязательные поля были заполнены для получения данных по пользователю Tboil'),JSON_UNESCAPED_UNICODE);
      exit;
}
