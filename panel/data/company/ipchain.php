...
<?php /*тут метатеги*/?>
<title>Компании IPCHhain - FULLDATA ЛЕНПОЛИГРАФМАШ</title>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    var tab = $('.table').DataTable({
          ...
          cache: false,
          "ajax": {
                    url: "/panel/data/company/get_IPcompany",
                    type: "POST",
    ...
    tab.on( 'key-focus', function ( e, datatable, cell, originalEvent ) {
            window.open('http://<?php echo $_SERVER["SERVER_NAME"];?>/panel/data/company/details_ipchain?inn='+(tab.row(cell[0][0]['row']).data()["INN"]));
        } );
  });
</script>
